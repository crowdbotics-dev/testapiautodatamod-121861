...
## Project Structure
    ...
    ├── testapiautodatamod_121861  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_121861`
...
2. Clone this repo and `cd testapiautodatamod_121861`
